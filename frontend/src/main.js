...
pluralCaseList.push( {plural: "taxiCallingServices/taxiCalls", pascal: "TaxiCallingServiceTaxiCall"} )
pluralCaseList.push( {plural: "taxiCallingServices/rides", pascal: "TaxiCallingServiceRide"} )
pluralCaseList.push( {plural: "taxiCallingServices/payments", pascal: "TaxiCallingServicePayment"} )
pluralCaseList.push( {plural: "taxiCallingServices/reviews", pascal: "TaxiCallingServiceReview"} )

pluralCaseList.push( {plural: "driverManagementServices/drivers", pascal: "DriverManagementServiceDriver"} )
