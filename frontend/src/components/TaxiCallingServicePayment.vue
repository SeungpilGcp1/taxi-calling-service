<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="receivePaymentDiagram" width="500">
                <ReceivePaymentCommand
                    @closeDialog="closeReceivePayment"
...
<script>
    ...
    export default {
        name: 'TaxiCallingServicePayment',
        components:{
            Money,
        },
        props: {
	...
	async created() {
        ...
        methods: {
            ...
            openReceivePayment() {
                this.receivePaymentDiagram = true;
            },
            closeReceivePayment() {
                this.receivePaymentDiagram = false;
            },
