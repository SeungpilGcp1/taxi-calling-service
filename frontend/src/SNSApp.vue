            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="taxiCalls"
                        to="/taxiCallingServices/taxiCalls"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="payments"
                        to="/taxiCallingServices/payments"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="reviews"
                        to="/taxiCallingServices/reviews"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="drivers"
                        to="/driverManagementServices/drivers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '택시 호출', 
                description: '고객이 택시를 호출하고 운전자에게 할당되는 과정을 담당', 
                key: 'taxiCalls', 
                route: '/taxiCallingServices/taxiCalls',
                ImageUrl: '',
            },
            { 
                title: '운행', 
                description: '운전자가 고객을 목적지로 안전하게 이동시키는 과정을 담당', 
                key: 'rides', 
                route: '/taxiCallingServices/rides',
                ImageUrl: '',
            },
            { 
                title: '결제', 
                description: '운행 완료된 후 결제 및 정산하는 과정을 담당', 
                key: 'payments', 
                route: '/taxiCallingServices/payments',
                ImageUrl: '',
            },
            { 
                title: '평가', 
                description: '운행 완료 후 평가를 남기는 과정을 담당', 
                key: 'reviews', 
                route: '/taxiCallingServices/reviews',
                ImageUrl: '',
            },
            { 
                title: '운전자', 
                description: '운전자 정보를 관리하는 과정을 담당', 
                key: 'drivers', 
                route: '/driverManagementServices/drivers',
                ImageUrl: '',
            },
